...
<div id="write_book" class="inner">
    <h2>수정</h2>
    <h3>내용을 변경하세요</h3>
    <form action="process/best_edit_process.php" method="post" enctype="multipart/form-data">
        <table>
            <tr>
                <td>책표지</td>
                <td><img src="/php/bookmenu/images/<?=$row['imgs']?>" alt="책 표지"><br>새로운 파일 선택<input type="file" name="imgs"></td>
            </tr>
            <tr>
                <td>글쓴이</td>
